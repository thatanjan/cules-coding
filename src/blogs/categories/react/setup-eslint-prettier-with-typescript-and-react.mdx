...
## Shameless Plug
I have published a redux-tookit crash course on my youtube channel. Redux-tookit is a tool to setup redux with react. It abstracts away all the complicated code. You can use redux easier than ever. And you will learn about redux toolkit by creating a simple todo application.

<Iframe title='Build the front End' videoID="rSa8sUC8m_4"  /> 

## Project Demo
You can demo the project from [ here ](https://redux-tookit-crash-course-demo.vercel.app/)
![Alt Text](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/q51topykw3wpv3y0armk.png)


[ View the Project code.](https://github.com/thatanjan/redux-toolkit-crash-course)

So like, share, and subscribe to [Cules Coding](https://www.youtube.com/channel/UCBaGowNYTUsm3IDaHbLRMYw?sub_confirmation=1). It takes a lot of effort to build those videos.
