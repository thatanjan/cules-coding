...
I am have done a video series on my youtube channel about how to build a static blogging site using JAMstack.

<Iframe title='Intro and Setup' videoID=""KYLBb1W1ZBA  /> 
<Iframe title='Build the front End' videoID="01q6hHwTuP0"  /> 
...
## Project Demo
You can demo the project from [ here ](https://jamstack-blog-demo.vercel.app/)
![Alt Text](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/owol9cfa63vw4n5t2zsr.png)

[ View the Project code. ](https://github.com/thatanjan/cules-blog-yt)
